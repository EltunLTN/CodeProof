...
export function CodeEditor({
  ...
  const extensions = useMemo(
    () => [
      ...
      EditorView.theme({
        "&": { backgroundColor: "#0b1324", color: "#dce7f5", fontSize: "14px" },
        ".cm-content": { fontFamily: "var(--font-geist-mono), Consolas, monospace", padding: "16px 0" },
        ".cm-line": { padding: "0 18px" },
        ".cm-gutters": { backgroundColor: "#0f1b30", color: "#60738e", border: "none" },
        ".cm-activeLineGutter": { backgroundColor: "#16243b", color: "#b7c9df" },
